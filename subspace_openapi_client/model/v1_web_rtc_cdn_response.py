...
def lazy_import():
    ...
    globals()['V1WebRtcCdnServer'] = V1WebRtcCdnServer


class V1WebRtcCdnResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'ice_servers': ([V1WebRtcCdnServer],),  # noqa: E501
            'ttl': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        'ice_servers': 'iceServers',  # noqa: E501
        'ttl': 'ttl',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1WebRtcCdnResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            ice_servers ([V1WebRtcCdnServer]): [optional]  # noqa: E501
