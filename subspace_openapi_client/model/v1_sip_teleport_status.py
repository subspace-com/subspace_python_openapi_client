...
class V1SipTeleportStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): if omitted defaults to "DISABLED", must be one of ["DISABLED", "ENABLED", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "DISABLED", must be one of ["DISABLED", "ENABLED", ]  # noqa: E501
