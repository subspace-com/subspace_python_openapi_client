...
class V1SipTeleportStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V1SipTeleportStatus - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "UNKNOWN", must be one of ["UNKNOWN", "DISABLED", "ENABLED", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UNKNOWN", must be one of ["UNKNOWN", "DISABLED", "ENABLED", ]  # noqa: E501
