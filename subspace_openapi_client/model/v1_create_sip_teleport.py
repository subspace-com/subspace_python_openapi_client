...
class V1CreateSipTeleport(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, destination, *args, **kwargs):  # noqa: E501
        """V1CreateSipTeleport - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, destination, *args, **kwargs):  # noqa: E501
        """V1CreateSipTeleport - a model defined in OpenAPI
