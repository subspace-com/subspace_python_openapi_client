...
class V1UpdateSipTeleport(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, destination, status, *args, **kwargs):  # noqa: E501
        """V1UpdateSipTeleport - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, destination, status, *args, **kwargs):  # noqa: E501
        """V1UpdateSipTeleport - a model defined in OpenAPI
