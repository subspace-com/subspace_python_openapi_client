...
class V1TransportType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V1TransportType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "UDP_TCP", must be one of ["UDP_TCP", "TLS", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "UDP_TCP", must be one of ["UDP_TCP", "TLS", ]  # noqa: E501
