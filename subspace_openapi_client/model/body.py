...
class Body(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, protocol, name, destination_ip, destination_port, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            subspace_port (int): Desired Subspace-assigned ingress port, optional. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, protocol, name, destination_ip, destination_port, *args, **kwargs):  # noqa: E501
        """Body - a model defined in OpenAPI
