...
class V1Protocol(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """V1Protocol - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): if omitted defaults to "udp", must be one of ["udp", "tcp", "udp_tcp", ]  # noqa: E501

        Keyword Args:
            value (str): if omitted defaults to "udp", must be one of ["udp", "tcp", "udp_tcp", ]  # noqa: E501
