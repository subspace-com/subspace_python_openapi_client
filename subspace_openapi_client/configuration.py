...
from subspace_openapi_client.exceptions import ApiValueError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.subspace.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("subspace_openapi_client")
