...
from subspace_openapi_client import rest
from subspace_openapi_client.configuration import Configuration
from subspace_openapi_client.exceptions import ApiTypeError, ApiValueError, ApiException
from subspace_openapi_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AcceleratorServiceApi()
        api_instance.accelerator_service_create  # this is an instance of the class Endpoint
        api_instance.accelerator_service_create()  # this invokes api_instance.accelerator_service_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.accelerator_service_create.callable or self.callable in this class
