...
class SipTeleportServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.sip_teleport_service_create_endpoint = _Endpoint(
            settings={
                'response_type': (V1SipTeleportResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/sipteleport',
        ...
        self.sip_teleport_service_delete_endpoint = _Endpoint(
            settings={
                'response_type': (V1SipTeleportResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/sipteleport/{id}',
        ...
        self.sip_teleport_service_get_endpoint = _Endpoint(
            settings={
                'response_type': (V1SipTeleportResponse,),
                'auth': [
                    'accessCode'
        ...
        self.sip_teleport_service_list_endpoint = _Endpoint(
            settings={
        ...
        self.sip_teleport_service_update_endpoint = _Endpoint(
            settings={
                'response_type': (V1SipTeleportResponse,),
                'auth': [
                    'accessCode'
    ...
    def sip_teleport_service_create(
        self,
        v1_create_sip_teleport,
        **kwargs
    ):
        """sip_teleport_service_create  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sip_teleport_service_create(v1_create_sip_teleport, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['v1_create_sip_teleport'] = \
            v1_create_sip_teleport
        return self.sip_teleport_service_create_endpoint.call_with_http_info(**kwargs)

    def sip_teleport_service_delete(
        self,
        id,
        **kwargs
    ):
        """sip_teleport_service_delete  # noqa: E501
        ...
        kwargs['id'] = \
            id
        return self.sip_teleport_service_delete_endpoint.call_with_http_info(**kwargs)

    def sip_teleport_service_get(
        self,
        id,
        **kwargs
    ):
        """sip_teleport_service_get  # noqa: E501
        ...
        kwargs['id'] = \
            id
        return self.sip_teleport_service_get_endpoint.call_with_http_info(**kwargs)

    def sip_teleport_service_list(
        self,
        **kwargs
    ):
        """sip_teleport_service_list  # noqa: E501
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.sip_teleport_service_list_endpoint.call_with_http_info(**kwargs)

    def sip_teleport_service_update(
        self,
        id,
        v1_update_sip_teleport,
        **kwargs
    ):
        """sip_teleport_service_update  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sip_teleport_service_update(id, v1_update_sip_teleport, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        kwargs['v1_update_sip_teleport'] = \
            v1_update_sip_teleport
        return self.sip_teleport_service_update_endpoint.call_with_http_info(**kwargs)
