...
class SessionServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __session_service_list(
            self,
            accelerator_id,
            **kwargs
        ):
            """session_service_list  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.session_service_list(accelerator_id, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['accelerator_id'] = \
                accelerator_id
            return self.call_with_http_info(**kwargs)

        self.session_service_list = _Endpoint(
            settings={
                'response_type': (V1ListSessionsResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/accelerator/{accelerator_id}/session',
                'operation_id': 'session_service_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__session_service_list
        )

        def __session_service_list2(
            self,
            accelerator_id,
            **kwargs
        ):
            """session_service_list2  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.session_service_list2(accelerator_id, async_req=True)
            >>> result = thread.get()
        ...
        self.session_service_list2 = _Endpoint(
            settings={
                'response_type': (V1ListSessionsResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/accelerators/{accelerator_id}/sessions',
                'operation_id': 'session_service_list2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__session_service_list2
        )
