    ...
    def __init__(self, api_client=None):
        ...
        def __project_service_create(
            ...
            **kwargs
            ...
            """project_service_create  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.project_service_create(async_req=True)
            >>> result = thread.get()
        ...
        def __project_service_get(
            ...
            **kwargs
            ...
            """project_service_get  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.project_service_get(id, async_req=True)
            >>> result = thread.get()
        ...
        def __project_service_list(
            ...
            **kwargs
            ...
            """project_service_list  # noqa: E501
        ...
        self.project_service_list = _Endpoint(
            settings={
                'response_type': (V1ListProjectsResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/project',
        ...
        def __project_service_update(
            ...
            **kwargs
            ...
            """project_service_update  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.project_service_update(id, async_req=True)
            >>> result = thread.get()
