...
class AcceleratorServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.accelerator_service_create_endpoint = _Endpoint(
            settings={
                'response_type': (V1Accelerator,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/accelerator',
        ...
        self.accelerator_service_delete_endpoint = _Endpoint(
            settings={
                'response_type': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/accelerator/{id}',
        ...
        self.accelerator_service_get_endpoint = _Endpoint(
            settings={
                'response_type': (V1Accelerator,),
                'auth': [
                    'accessCode'
        ...
        self.accelerator_service_list_endpoint = _Endpoint(
            settings={
                'response_type': (V1ListAcceleratorResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/accelerator',
        ...
        self.accelerator_service_update_endpoint = _Endpoint(
            settings={
                'response_type': (V1Accelerator,),
                'auth': [
                    'accessCode'
    ...
    def accelerator_service_create(
        self,
        body,
        **kwargs
    ):
        ...
        kwargs['body'] = \
            body
        return self.accelerator_service_create_endpoint.call_with_http_info(**kwargs)

    def accelerator_service_delete(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.accelerator_service_delete_endpoint.call_with_http_info(**kwargs)

    def accelerator_service_get(
        self,
        id,
        **kwargs
    ):
        ...
        kwargs['id'] = \
            id
        return self.accelerator_service_get_endpoint.call_with_http_info(**kwargs)

    def accelerator_service_list(
        self,
        **kwargs
    ):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.accelerator_service_list_endpoint.call_with_http_info(**kwargs)

    def accelerator_service_update(
        self,
        id,
        body1,
        **kwargs
        ...
        kwargs['body1'] = \
            body1
        return self.accelerator_service_update_endpoint.call_with_http_info(**kwargs)
