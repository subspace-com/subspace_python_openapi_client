...
class WebRtcCdnServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.web_rtc_cdn_service_get_web_rtc_cdn_endpoint = _Endpoint(
            settings={
                'response_type': (V1WebRtcCdnResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/webrtc-cdn',
                'operation_id': 'web_rtc_cdn_service_get_web_rtc_cdn',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def web_rtc_cdn_service_get_web_rtc_cdn(
        self,
        **kwargs
    ):
        """web_rtc_cdn_service_get_web_rtc_cdn  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.web_rtc_cdn_service_get_web_rtc_cdn(async_req=True)
        >>> result = thread.get()
        ...
        return self.web_rtc_cdn_service_get_web_rtc_cdn_endpoint.call_with_http_info(**kwargs)
