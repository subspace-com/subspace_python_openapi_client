...
class GlobalTurnServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __global_turn_service_get_global_turn(
            self,
            **kwargs
        ):
            """global_turn_service_get_global_turn  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.global_turn_service_get_global_turn(async_req=True)
            >>> result = thread.get()
        ...
        self.global_turn_service_get_global_turn = _Endpoint(
            settings={
                'response_type': (V1GlobalTurnResponse,),
                'auth': [
                    'accessCode'
                ],
                'endpoint_path': '/v1/globalturn',
                'operation_id': 'global_turn_service_get_global_turn',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__global_turn_service_get_global_turn
        )
