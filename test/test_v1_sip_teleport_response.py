...
class TestV1SipTeleportResponse(unittest.TestCase):
    """V1SipTeleportResponse unit test stubs"""
    ...
    def testV1SipTeleportResponse(self):
        """Test V1SipTeleportResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = V1SipTeleportResponse()  # noqa: E501
        pass
