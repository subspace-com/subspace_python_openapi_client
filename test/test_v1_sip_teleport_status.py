...
class TestV1SipTeleportStatus(unittest.TestCase):
    """V1SipTeleportStatus unit test stubs"""
    ...
    def testV1SipTeleportStatus(self):
        """Test V1SipTeleportStatus"""
        # FIXME: construct object with mandatory attributes with example values
        # model = V1SipTeleportStatus()  # noqa: E501
        pass
